...
CREATE OR REPLACE FUNCTION UPDATE_INVENTORY_COUNT()
    ...
    BEGIN 
        ...
        ELSE
            ...
            RAISE NOTICE '%', NEW.INVENTORY_ID;
            
            -- UPDATE INVENTORY SET INVENTORY_COUNT = Inventory_count+NEW_COUNT WHERE INVENTORY_ID = NEW.INVENTORY_ID;  
            RETURN NEW;
        END IF;
    END;
    $$ LANGUAGE plpgsql;
...
INSERT INTO PRODUCT (INVENTORY_ID,PRODUCT_NAME, PRODUCT_COUNT, PRODUCT_DESCRIPTION, PRODUCT_TYPE) VALUES('ec334c28-4bac-425f-ad73-ca9a6a1d1512', 'HAA', 2,'haahshd', 'shoes');
...
UPDATE PRODUCT SET PRODUCT_COUNT = 5;
